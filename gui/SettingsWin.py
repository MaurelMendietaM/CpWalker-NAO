...
class SettingsWindow(QtGui.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.label_background.setPixmap(QtGui.QPixmap("gui/img/Back_1.png"))
        ...
        start=QtGui.QPixmap("gui/img/Intro_button.png")
        ...
        Therapy=QtGui.QPixmap("gui/img/start_therapy.png")
        ...
        self.DataDisplay['ip'].setStyleSheet("font-size:35px; Arial")
        ...
        self.DataDisplay['ip1'].setStyleSheet("font-size:35px; Arial")
        ...
        self.DataDisplay['ip1'].addItem("192.168.1.75")
        self.DataDisplay['ip1'].addItem("Cambiar direccion IP") 

        #Use robot comboBox
        self.DataDisplay['UseRobot'] = QtGui.QComboBox(self)
        self.DataDisplay['UseRobot'].setStyleSheet("font-size:35px; Arial")
